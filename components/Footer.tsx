  ...
  return (
    <footer className="w-full bg-zinc-900 border-t border-zinc-800 text-zinc-400 py-8 text-center mt-12 flex flex-col items-center gap-6 z-10 relative">
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <a 
          href="https://www.buymeacoffee.com/yuga" 
          target="_blank" 
          rel="noopener noreferrer"
          className="px-6 py-2 bg-[#FFDD00] text-black font-bold rounded-full hover:bg-[#FFEA00] transition-colors flex items-center gap-2 shadow-[0_0_15px_rgba(255,221,0,0.4)] hover:scale-105 transform active:scale-95"
        >
          <span>☕</span> Buy Jules a Coffee
        </a>
        ...
        <div className="flex flex-col items-center justify-center bg-zinc-800/50 px-4 py-1 rounded-lg border border-zinc-700">
          ...
          <img 
            src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fself-evolving.dev&count_bg=%2322C55E&title_bg=%23333333&icon=googleanalytics.svg&icon_color=%23E7E7E7&title=VISITORS&edge_flat=false" 
            alt="Visitor Count"
            className="h-5"
          />
        </div>
