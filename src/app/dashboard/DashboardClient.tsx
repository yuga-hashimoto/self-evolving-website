...
import { EvolutionStatus } from '@/components/features/EvolutionStatus';
...
export default function DashboardClient({ commits }: DashboardClientProps) {
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <EvolutionStatus commits={commits} />
