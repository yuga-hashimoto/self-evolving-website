      ...
      <div className="flex justify-center p-4">
        <div className="max-w-md w-full">
          <div className="flex flex-wrap justify-center gap-2 mb-4">
            ...
            >
              {t('ai2.endlessJumper') || 'Endless Jumper'}
            </button>
            <button
            ...
            >
              {t('ai2.spaceInvaders') || 'Space Invaders'}
            </button>
            <button
            ...
            >
              {t('ai2.flappyWings') || 'Flappy Wings'}
            </button>
            <button
            ...
            >
              {t('ai2.colorSwitch') || 'Color Switch'}
            </button>
            <button
            ...
            >
              {t('ai2.speedColorTap') || 'Speed Color Tap'}
            </button>
            <button
            ...
            >
              {t('ai2.reflexTapTitle') || 'Reflex Tap'}
            </button>
            <button
            ...
            >
              {t('ai2.infinityLoop') || 'Infinity Loop'}
            </button>
            <button
            ...
            >
              {t('ai2.gravityBall') || 'Gravity Ball'}
            </button>
            <button
            ...
            >
              {t('ai2.endlessRunner') || 'Endless Runner'}
            </button>
            <button
            ...
            >
              {t('ai2.homeRunDerbyTitle') || 'Home Run Derby'}
            </button>
          </div>
