  ...
  return (
    <div className="flex flex-col items-center p-4">
      <div className="mb-4 text-center">
        <p className="text-xl font-bold">{t('ai2.pong') || 'Pong'}</p>
        <p className="text-sm text-gray-600">{t('ai2.pongDescription') || 'Bounce the ball past the computer!'}</p>
      ...
      <div className="mt-4 flex gap-2">
        {!playing && (
          ...
          >
            {gameOver ? (t('ai2.restart') || 'Restart') : (t('ai2.start') || 'Start')}
          </button>
        )}
        {playing && (
          <button
