  ...
  return (
    <div className="w-full flex justify-center gap-4 mt-6">
      ...
      >
        ...
        <IconMimo size={20} className="text-purple-400 group-hover:scale-110 transition-transform z-10" />
        <span className="text-purple-300 font-bold z-10">Support Mimo</span>
      </Link>
      ...
      >
        ...
        <IconGrok size={20} className="text-blue-400 group-hover:scale-110 transition-transform z-10" />
        <span className="text-blue-300 font-bold z-10">Support Grok</span>
      </Link>
    </div>
  );
}
